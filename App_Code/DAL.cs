...
public class DAL
{
    ...
    public string Isostart = " Alter Database walthfctryselect Set Allow_SnapShot_isolation on; Set Transaction Isolation level read uncommitted;Set nocount on; Begin Tran  ";
    public string IsoEnd = " Commit Tran ";
    public string dBName = "walthfctry";
