...
(function (l, q) {
    var e = function (b, c) {
        b.extend(!0, c.defaults, { dom: "<'row'<'col-sm-6 col-xs-6'l><'col-sm-6 col-xs-6'f>><'row'<'col-sm-12 col-xs-12'tr>><'row'<'col-sm-5 col-xs-2'i><'col-sm-7 col-xs-10'p>>", renderer: "bootstrap" }); b.extend(c.ext.classes, { sWrapper: "dataTables_wrapper form-inline dt-bootstrap", sFilterInput: "form-control input-sm", sLengthSelect: "form-control input-sm" }); c.ext.renderer.pageButton.bootstrap = function (g, e, r, s, i, m) {
