<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="ChangeTransPass.aspx.cs" Inherits="ChangeTransPass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="content-header">
            <h1>Change Transaction Password
            </h1>
        </div>
        <div class="content">
            <div class="row">
