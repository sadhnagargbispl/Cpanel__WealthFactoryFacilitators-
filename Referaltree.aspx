...
<link href="css/tree.css" type="text/css" rel="stylesheet" />
    <style type="text/css">
        #dhtmltooltip { BORDER-RIGHT: black 1px solid; PADDING-RIGHT: 2px; BORDER-TOP: black 1px solid; PADDING-LEFT: 2px; Z-INDEX: 100; FILTER: progid:DXImageTransform.Microsoft.Shadow(color=gray,direction=135); LEFT: 0px; VISIBILITY: hidden; PADDING-BOTTOM: 2px; BORDER-LEFT: black 1px solid; WIDTH: 300px; PADDING-TOP: 2px; BORDER-BOTTOM: black 1px solid; POSITION: absolute; BACKGROUND-COLOR: lightyellow }
	    #dhtmlpointer { Z-INDEX: 101; LEFT: 0px; VISIBILITY: hidden; POSITION: absolute }
	    .style2 { FONT-SIZE: 12px }
	</style>
    <link href="dtree/dtree.css" type="text/css" rel="stylesheet" />
   <link rel="stylesheet" type="text/css"  href="theme-golden.css">
          ...
          <div>
             <div style="vertical-align:top; position: absolute; top: 8px; left: 0px;">
                <table cellpadding="0" cellspacing="1" border="0" width="450px" style="vertical-align:top;">
				  ...
				  <tr style="font-weight: bold; font-size: 10px; font-family: Verdana;">
                    <td>
                        <asp:Button ID="cmdBack" runat="server" Text="Home" class="btn btn_default" onclick="cmdBack_Click"/>
                    </td>
                </tr>
			        </tr>
		        </table>
