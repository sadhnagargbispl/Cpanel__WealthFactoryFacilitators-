...
public partial class Complain : System.Web.UI.Page
{
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string scrname;
            string StrSql1 = "Insert into Trnactive (Transid, Rectimestamp) values(" + HdnCheckTrnns.Value + ", getdate())";
            ...
            if (updateEffect > 0)
            {
                ...
                else if (string.IsNullOrWhiteSpace(TxtMobl.Text))
                {
                ...
                string Sql = "INSERT INTO M_ComplaintMaster(IDNO, CTypeID, CType, Complaint, Subject, MemberName, Mobileno, Email) VALUES " +
                             ...
                             "N'" + TxtSubject.Text.Trim() + "', '" + TxtName.Text.Trim() + "', '" + TxtMobl.Text.Trim() + "', '" + TxtEmail.Text.Trim() + "')";
                ...
                else
                {
                    ...
                    // Uncomment to enable mail and SMS functionalities
                    // SendMail();
                    // SendToMemberMail();
                    ...
                    spanError.InnerText = "Your complaint has been successfully submitted on " + DateTime.Now.ToString("dd MMMM yyyy, hh:mm dddd") +
                                          ". Your Complaint No. is " + LblCompalin.Text + ". Our customer service representative will get in touch with you shortly. Please be patient.";
