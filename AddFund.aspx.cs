...
public partial class AddFund : System.Web.UI.Page
{
    ...
    protected bool CheckDDno()
    {
        ...
        if (Convert.ToInt32(DdlPaymode.SelectedValue) != 8)
        {
            ...
            {
                s = "select * from " + Obj.dBName + "..WalletReq where ChqNo = '" + (TxtDDNo.Text) + "' and IsApprove <> 'R'";
    ...
    protected void SaveRequest()
    {
     ...
     "'Amount: " + TxtAmount.Text + "',Getdate()," + Session["FormNo"] + ")";
                        ...
                        int ReqNo;
                        str = " Select Max(ReqNo) as ReqNo FROM " + Obj.dBName + "..WalletReq WHERE Formno='" + Session["Formno"] + "' AND Amount='" + TxtAmount.Text + "'";
                        dt1 = new DataTable();
